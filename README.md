...
<table>
  ...
  <tbody>
      ...
      <tr>
          <td rowspan=6><a href="https://github.com/shinji-san/SecretSharingDotNet/actions?query=workflow%3A%22SecretSharingDotNet+NuGet%22" target="_blank"><img src="https://github.com/shinji-san/SecretSharingDotNet/workflows/SecretSharingDotNet%20NuGet/badge.svg?branch=v0.3.0" alt="SecretSharingDotNet NuGet"/></a></td>
          <td rowspan=6>expected:<br/>v0.3.0</td>
          <td rowspan=6>expected:<br/>v0.3.0</td>
          <td>FX 4.6</td>
      </tr>
      <tr>
