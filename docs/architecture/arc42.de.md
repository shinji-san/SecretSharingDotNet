...
flowchart TD
    ...
    subgraph gh["GitHub Actions"]
        ...
        subgraph publish["publishing.yml - Trigger: Tag v*.*.*"]
            pubGate["SemVer-Gate<br/>Tag-Muster, dann Versionsabgleich"]
    ...
    repo -->|push / PR| codeql
    repo -->|v-Tag, beliebiger Branch| pubGate
    pubGate --> pubTest
    pubTest --> pubBuild
    pubBuild --> nuget
