...
flowchart TD
    ...
    subgraph gh["GitHub Actions"]
        ...
        subgraph publish["publishing.yml - trigger: tag v*.*.*"]
            pubGate["SemVer gate<br/>tag pattern, then version match"]
            pubTest["test-windows<br/>net472 / net48 / net481"]
            pubBuild["build<br/>needs: test-windows<br/>dotnet pack, OIDC push"]
        end
    end
