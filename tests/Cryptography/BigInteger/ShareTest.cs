...
public class ShareTest
{
    ...
    public void ReissueWithSecurityLevel_WithAProvider_KeepsTheFieldAndContradictionChecks()
    {
        ...
        using var tooLarge = new Share<BigInteger>(new BigIntCalculator(1), new BigIntCalculator(200));
        using var recorded = new Share<BigInteger>(new BigIntCalculator(1), new BigIntCalculator(10), 13);
