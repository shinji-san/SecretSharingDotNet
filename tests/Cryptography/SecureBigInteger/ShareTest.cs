...
public class ShareTest
{
    ...
    [InlineData(5UL, 10UL)]
    [InlineData(1UL, 0UL)]
    // Above long.MaxValue — exercises the ulong implicit conversion (commit f5a8818).
    [InlineData(12345678901234567890UL, 987654321098765430UL)]
    public void Constructor_ValidInputs_ShouldInitializeCorrectly(ulong index, ulong value)
    {
        // Arrange
        using Calculator<SecureBigInteger> expectedIndex = (SecureBigInteger)index;
        using Calculator<SecureBigInteger> expectedValue = (SecureBigInteger)value;
    ...
    [InlineData(-50)]
    [InlineData(-100)]
    public void Constructor_NegativeIndex_ShouldThrowArgumentOutOfRangeException(long index)
    {
        // Arrange
        using Calculator<SecureBigInteger> value = (SecureBigInteger)10;
    ...
    {
        // Arrange
        using var index = SecureBigIntCalculator.Zero;
        using Calculator<SecureBigInteger> value = (SecureBigInteger)10;
    ...
    {
        // Arrange
        Calculator<SecureBigInteger> index = null;
        using Calculator<SecureBigInteger> value = (SecureBigInteger)10;

        // Act & Assert
        var ex = Assert.Throws<ArgumentNullException>(() => new Share<SecureBigInteger>(index, value));
    ...
    {
        // Arrange
        using Calculator<SecureBigInteger> index = (SecureBigInteger)5;
        Calculator<SecureBigInteger> value = null;
    ...
    public void Constructor_ByteArrays_NullIndexBytes_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var ex = Assert.Throws<ArgumentNullException>(() => new Share<SecureBigInteger>(indexBytes, valueBytes));
    ...
    public void Constructor_ByteArrays_ValidInputs_InitializesCorrectly()
    {
        ...
        // Act
        using var share = new Share<SecureBigInteger>(indexBytes, valueBytes);

        // Assert
        using var expectedIndex = new SecureBigIntCalculator(5);
        using var expectedValue = new SecureBigIntCalculator(10);
        Assert.Equal(expectedIndex, share.Index);
        Assert.Equal(expectedValue, share.Value);
    }
    ...
    {
        // Arrange
        var index = new SecureBigIntCalculator(4);
        var value = new SecureBigIntCalculator(10);
        using var share = new Share<SecureBigInteger>(index, value);
    ...
    {
        // Arrange
        var index = new SecureBigIntCalculator(5);
        var value = new SecureBigIntCalculator(10);
        using var share = new Share<SecureBigInteger>(index, value);
    ...
    public void ToString_ValidShare_ShouldReturnFormattedString(long index, long value, string expected)
    {
        // Arrange
        using var share = new Share<SecureBigInteger>((SecureBigInteger)index, (SecureBigInteger)value);
    ...
    public void Constructor_ValidPinnedInput_ShouldParseCorrectly()
    {
        ...
        // Assert
        using var expectedIndex = new SecureBigIntCalculator(11);
        using var expectedValue = new SecureBigIntCalculator(-86);
        Assert.Equal(expectedIndex, share.Index);
        Assert.Equal(expectedValue, share.Value);
    }
    ...
    public void ToString_FromValidShare_ReturnsCoordinatesSeparatedWithMinus(string input, string expected)
    {
        ...
        using var shareUnderTest = new Share<SecureBigInteger>(pinned);
    ...
    public void ToCharArray_WithParameters_ShouldReturnFormattedChars(
        long index, long value, bool uppercase, bool withPrefix, string expected)
    {
        // Arrange
        using var share = new Share<SecureBigInteger>((SecureBigInteger)index, (SecureBigInteger)value);
    ...
    public void Constructor_WithLowerHexPrefix_ShouldParse(string shareString, int expectedIndex, int expectedValue)
    {
        ...
        // Assert
        using var expectedIndexCalc = new SecureBigIntCalculator(expectedIndex);
        using var expectedValueCalc = new SecureBigIntCalculator(expectedValue);
    ...
    public void RoundTrip_ToCharArrayWithPrefix_ShouldParseBack(long index, long value)
    {
        // Arrange
        using var original = new Share<SecureBigInteger>((SecureBigInteger)index, (SecureBigInteger)value);

        // Act
        using var chars = original.ToCharArray(uppercase: true, withPrefix: true);
        using var parsed = new Share<SecureBigInteger>(chars);
    ...
    public void GetCharCount_MatchesToCharArrayLength(long index, long value, bool withPrefix, int expected)
    {
        // Arrange
        using var share = new Share<SecureBigInteger>((SecureBigInteger)index, (SecureBigInteger)value);
    ...
    public void CompareTo_ShouldReturnCorrectComparisonResult()
    {
        ...
        using var share2 = new Share<SecureBigInteger>(new SecureBigIntCalculator(10), new SecureBigIntCalculator(20));
        using var sameIndexShare = new Share<SecureBigInteger>(new SecureBigIntCalculator(5), new SecureBigIntCalculator(15));
    ...
    public void Dispose_ReleasesIndexAndValue()
    {
        ...
        var index = new SecureBigIntCalculator(5);
        var value = new SecureBigIntCalculator(10);
        var share = new Share<SecureBigInteger>(index, value);
    ...
    {
        // Arrange
        var share = new Share<SecureBigInteger>(new SecureBigIntCalculator(4), new SecureBigIntCalculator(10));
        share.Dispose();
    ...
    /// <c>with</c> expression must not be allowed to produce a shallow copy of
